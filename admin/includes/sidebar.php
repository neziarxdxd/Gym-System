<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-users"></i> <span>Manage Members   </span><?php include 'dashboard-usercount.php';?></span></a>
      <ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-dumbbell"></i> <span>Gym Equipment  </span><?php include 'dashboard-equipcount.php';?> </span></a>
    <ul>
